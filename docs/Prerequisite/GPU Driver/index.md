...
See [ROCm system requirements](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/reference/system-requirements.html#rdna-os).

Supported:
- Ubuntu 24.04 LTS Server (no GUI)
- Ubuntu-mate (Ubuntu 24.04 LTS)
- Ubuntu 24.04.3, Ubuntu 22.04.5, RHEL 10.1, RHEL 9.7

Not Supported:
- Ubuntu 24.04 LTS Cinnamon (cannot boot after amdgpu driver install)
...
Recommended: fix 16GiB for VGRAM.
